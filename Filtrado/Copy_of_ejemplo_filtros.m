...
I = imnoise(I,'salt & pepper',0.02); figure; imshow(I) %Agregamos ruido sal y pimienta
...
subplot(1,5,1), imshow(I); title('Original con ruido');
subplot(1,5,2), imshow(Im_f); title('Pasa Bajas');
subplot(1,5,3), imshow(Im_g); title('Filtro Gaussiano');
subplot(1,5,4), imshow(Im_m); title('Filtro Mediana');
